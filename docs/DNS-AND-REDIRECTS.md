...
| CNAME | `www` | `boomeringwa.github.io` | 3600 |

`BoomeringWA` is the GitHub account hosting the site
(repository: `BoomeringWA/The-Basketball-Man`). The CNAME points at the account's
...
2. Client signs off on the preview at `https://boomeringwa.github.io/The-Basketball-Man/`.
