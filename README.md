...
subfolder such as `boomeringwa.github.io/The-Basketball-Man/`, or opened straight off
...
1. The repository is `BoomeringWA/The-Basketball-Man` (public, as GitHub Pages
...
2. Upload the *contents* of this folder to the repository root — not the folder
   ...
   ```
   git remote add origin https://github.com/BoomeringWA/The-Basketball-Man.git
   git branch -M main
...
4. A preview appears within a minute at
   `https://boomeringwa.github.io/The-Basketball-Man/`. Send that link to the
